...
west build -p -b nrf54l15dk/nrf54l15/cpuapp -d build_54l -- -DFILE_SUFFIX=delta -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"1.0.0+0\"
@REM @REM Backup original hex file
copy build_54l\merged.hex delta_100.hex
