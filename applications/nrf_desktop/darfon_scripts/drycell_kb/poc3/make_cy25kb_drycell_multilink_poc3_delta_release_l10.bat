...
::West build
SET NAME=cy25kb_drycell_multilink_poc3_delta_release
SET BUILD_FOLDER=cy25kb_dry_multi_poc3_delta_re_l10
SET OVERLAY=cy25kb_drycell_poc3_gpioled_nrf54l10
