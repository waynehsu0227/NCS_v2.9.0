...
SET BUILD_FOLDER=cy25kb_delta_only_l10
SET OVERLAY=cy25kb_drycell_poc3_gpioled_nrf54l10
SET BOARD=nrf54l15dk/nrf54l10/cpuapp

@REM @REM Build the application
west build -p -b %BOARD% -d build_%BUILD_FOLDER% -- -DCONF_FILE=prj_%NAME%.conf -DDTC_OVERLAY_FILE=%OVERLAY%.overlay -DFILE_SUFFIX=%NAME% -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"1.0.0+0\"
