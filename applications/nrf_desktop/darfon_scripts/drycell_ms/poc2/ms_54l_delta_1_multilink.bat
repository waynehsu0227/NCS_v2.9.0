...
west build -p -b nrf54l15pdk_nrf54l15_cpuapp -d build_ms_poc2_delta_dfu -- -DDTC_OVERLAY_FILE="cy25ms_drycell_poc2.overlay" -DCONF_FILE=prj_cy25ms_drycell_multilink_poc2_delta.conf -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"1.0.0+0\"
