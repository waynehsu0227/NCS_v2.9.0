...
if errorlevel 4 call flash_cy25ms_drycell_multilink_poc2_release_l15.bat
if errorlevel 3 call flash_cy25ms_drycell_ble_poc2_release_l15.bat
if errorlevel 2 call flash_cy25ms_drycell_poc2_release_l15.bat
if errorlevel 1 call flash_cy25ms_drycell_poc2_l15.bat
