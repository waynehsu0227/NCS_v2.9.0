...
static const struct hid_keymap hid_keymap[] = {
	...
	{ KEY_ID(0, 3), 0x04, REPORT_ID_MOUSE }, /* SW_Forward Mouse Button */
	{ KEY_ID(0, 4), 0x05, REPORT_ID_MOUSE }, /* SW_Backward Mouse Button */
	//{ KEY_ID(0, 5), 0x06, REPORT_ID_MOUSE }, /* Tilt_R Mouse Button */
	//{ KEY_ID(0, 6), 0x07, REPORT_ID_MOUSE }, /* Tilt_L Mouse Button */
};
