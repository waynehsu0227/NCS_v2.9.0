...
#if CONFIG_CY25
	LED_SYSTEM_STATE_LOW_BAT,
#endif
#if CONFIG_CY25KB_RECHARGEABLE
	LED_SYSTEM_STATE_FULL,
#endif
...
enum led_collabs_state {
	LED_COLLABS_STATE_OFF,
	LED_COLLABS_STATE_ON,
	LED_COLLABS_STATE_BLINK,

	LED_COLLABS_STATE_COUNT
};

enum led_id_collabs {
	COLLABS_LED_ID_SHARE,
	COLLABS_LED_ID_CAMERA_W,
    COLLABS_LED_ID_CAMERA_R,
    COLLABS_LED_ID_MIC_W,
    COLLABS_LED_ID_MIC_R,
    COLLABS_LED_ID_CHAT,

	/** Number of LEDs. */
	COLLABS_LED_ID_COUNT
};
