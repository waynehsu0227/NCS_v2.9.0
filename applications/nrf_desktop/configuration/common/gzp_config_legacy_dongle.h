...
#ifndef __GZP_CONFIG_LEGACY_DONGLE_H
#define __GZP_CONFIG_LEGACY_DONGLE_H
...
/**
 * nRF Desktop application uses an application-specific Gazell configuration file.
 * The configuration file switches to using Gazell pairing address and secret key from nRFready
 * Desktop 2 reference design to ensure compatibility with nRFready Desktop 2 dongle.
 */
...
#endif /* __GZP_CONFIG_LEGACY_DONGLE_H */
