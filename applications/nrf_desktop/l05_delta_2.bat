...
west build -p -b nrf54l15dk/nrf54l05/cpuapp -d build_l05_delta -- -DFILE_SUFFIX=delta_gazell_ble -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"2.0.0+0\"
@REM Backup original hex file
copy build_l05_delta\merged.hex delta_200.hex
...
python  %ZEPHYR_BASE%\..\delta_dfu\scripts\patch_with_arg.py -d build_l05_delta
