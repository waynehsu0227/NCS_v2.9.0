...
#if (CONFIG_DELL_PAIR_ENABLE) && (CONFIG_DESKTOP_PERIPHERAL_TYPE_MOUSE)
				//mouse	
				extern void auth_passkey_entry(struct bt_conn *conn);
				extern void auth_cancel(struct bt_conn *conn);
